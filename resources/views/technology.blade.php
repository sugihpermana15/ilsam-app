...
@section('title')
  @yield('page_title', __('website.titles.technology'))
@endsection

@section('main')
  @php
    $ws = \App\Support\WebsiteSettings::all();
    $breadcrumbBgRaw = data_get($ws, 'technology.page.breadcrumb_bg', 'assets/img/img4.jpg');
      ...
      <div class="row align-items-center justify-content-between">
        <div class="col-12">
          <div class="breadcrumb__content text-center">
            <h1 class="breadcrumb__title color-white title-animation">@yield('breadcrumb_title', __('website.nav.menu.technology'))</h1>
            <div class="breadcrumb__menu d-inline-flex justify-content-center">
              <nav>
                <ul>
                  ...
                  <li class="active"><span>@yield('breadcrumb_title', __('website.nav.menu.technology'))</span></li>
                </ul>
              </nav>
            </div>
          </div>
