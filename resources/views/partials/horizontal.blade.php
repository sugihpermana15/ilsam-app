<aside class="pe-app-sidebar horizontal-sidebar" id="horizontal-aside">
    @php
        $horizontalHomeUrl = route('home');
        if (auth()->check()) {
            $isUserRole = ((auth()->user()->role?->role_name ?? null) === 'Users') || ((int) auth()->user()->role_id === 3);
            $horizontalHomeUrl = $isUserRole ? route('user.dashboard') : route('admin.dashboard');
        }
    @endphp
    <div class="pe-app-sidebar-logo px-6 d-flex align-items-center position-relative">
        <!--begin::Brand Image-->
        <a href="{{ $horizontalHomeUrl }}" class="fs-18 fw-semibold">
        ...
        <ul class="pe-horizontal-menu list-unstyled" id="horizontal-menu">
            ...
            <li class="pe-slide pe-has-sub">
                ...
                <ul class="pe-slide-menu collapse" id="collapsePages">
                    ...
                    <li class="pe-slide pe-has-sub">
                        <a href="#collapseProfile" class="pe-nav-link" data-bs-toggle="collapse" aria-expanded="false"
