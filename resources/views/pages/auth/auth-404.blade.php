...
@section('content')
    ...
    <!-- START -->
    <div>
        <img src="{{ asset('assets/img/auth/login_bg.jpg') }}" alt="{{ __('errors.pages.common.auth_bg_alt') }}"
            class="auth-bg light w-full h-full opacity-60 position-absolute top-0">
        <img src="{{ asset('assets/img/auth/auth_bg_dark.jpg') }}" alt="{{ __('errors.pages.common.auth_bg_alt') }}" class="auth-bg d-none dark">
        <div class="container">
            <div class="row justify-content-center align-items-center min-vh-100 py-10">
                <div class="col-lg-8">
                    <div class="position-relative text-center">
                        <img class="img-fluid min-h-320px" src="{{ asset('assets/img/style2/404/404.svg') }}"
