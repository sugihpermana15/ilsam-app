                ...
                <div class="col-lg-8">
                    <div class="position-relative text-center">
                        ...
                        <div class="mt-4 mt-md-16 text-center">
                            <h1 class="fw-semibold fs-45"><span class="fw-bold text-primary">Oops! </span>Halaman tidak
                                ditemukan</h1>
                            <p class="text-muted fs-16 mb-8">URL yang Anda akses tidak tersedia atau sudah dipindahkan.</p>
                            <a href="{{ route('home') }}" class="btn btn-primary">Back to Home<i
