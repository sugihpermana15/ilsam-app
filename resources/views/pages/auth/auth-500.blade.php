...
@section('title', __('errors.titles.500'))
            ...
            <div class="row justify-content-center align-items-center min-vh-100 py-10">
                <div class="col-lg-8">
                    <div class="position-relative text-center">
                        <img class="min-h-320px img-fluid" src="assets/images/vector/500.svg" alt="{{ __('errors.pages.common.vector_alt') }}">
                        <div class="mt-4 mt-md-16 text-center">
                            <h1 class="fw-semibold fs-45"><span class="fw-bold text-primary">{{ __('errors.pages.500.headline_prefix') }} </span>{{ __('errors.pages.500.headline') }}</h1>
                            <p class="text-muted fs-16 mb-8">{{ __('errors.pages.500.desc') }}</p>
