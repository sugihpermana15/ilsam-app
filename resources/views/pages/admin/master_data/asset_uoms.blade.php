...
@section('title', 'Master Satuan Asset | IGI')

@section('title-sub', 'Master Data Satuan Asset')
@section('pagetitle', 'Master Satuan Asset')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h5 class="card-title mb-0">Master Satuan Asset</h5>
      ...
      <div class="modal-content">
        <form method="POST" action="{{ route('admin.asset_uoms.store') }}">
          ...
          <div class="modal-header">
            <h5 class="modal-title">Tambah Satuan Asset</h5>
          ...
          <div class="modal-body">
            ...
            <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="mis: pcs" required>
          </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <form method="POST" action="{{ $editRow ? route('admin.asset_uoms.update', $editRow->id) : '#' }}" id="editForm">
          ...
          <div class="modal-header">
            <h5 class="modal-title">Edit Satuan Asset</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
