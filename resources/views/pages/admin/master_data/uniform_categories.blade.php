...
@section('title', 'Master Kategori Seragam | IGI')

@section('title-sub', 'Master Data Kategori Seragam')
@section('pagetitle', 'Master Kategori Seragam')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h5 class="card-title mb-0">Master Kategori Seragam</h5>
