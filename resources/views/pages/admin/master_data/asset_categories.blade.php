...
@section('title', 'Master Kategori Asset | IGI')

@section('title-sub', 'Master Data Kategori Asset')
@section('pagetitle', 'Master Kategori Asset')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h5 class="card-title mb-0">Master Kategori Asset</h5>
      ...
      <div class="modal-content">
        <form method="POST" action="{{ route('admin.asset_categories.store') }}">
          ...
          <div class="modal-header">
            <h5 class="modal-title">Tambah Kategori Asset</h5>
          ...
          <div class="modal-body">
            ...
            <input type="text" name="code" class="form-control" value="{{ old('code') }}" placeholder="mis: IT" required>

            <label class="form-label mt-2">Nama</label>
            <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="mis: Information Technology" required>

            <label class="form-label mt-2">Prefix Asset Code</label>
            <input type="text" name="asset_code_prefix" class="form-control" value="{{ old('asset_code_prefix') }}" placeholder="mis: IT" required>
            <small class="text-muted">Digunakan untuk format asset code: IGI-{PREFIX}-...</small>
          </div>
