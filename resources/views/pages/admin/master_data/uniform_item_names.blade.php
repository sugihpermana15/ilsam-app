...
@section('title', 'Master Nama Item Seragam | IGI')

@section('title-sub', 'Master Data Nama Item Seragam')
@section('pagetitle', 'Master Nama Item Seragam')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h5 class="card-title mb-0">Master Nama Item Seragam</h5>
      ...
      <div class="modal-content">
        <form method="POST" action="{{ route('admin.uniform_item_names.store') }}">
          ...
          <div class="modal-header">
            <h5 class="modal-title">Tambah Nama Item</h5>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <form method="POST" action="{{ $editRow ? route('admin.uniform_item_names.update', $editRow->id) : '#' }}" id="editForm">
          ...
          <div class="modal-header">
            <h5 class="modal-title">Edit Nama Item</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
