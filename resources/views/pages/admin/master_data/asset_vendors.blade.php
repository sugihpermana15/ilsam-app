...
@section('title', 'Master Vendor Asset | IGI')

@section('title-sub', 'Master Data Vendor Asset')
@section('pagetitle', 'Master Vendor Asset')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h5 class="card-title mb-0">Master Vendor/Supplier Asset</h5>
      ...
      <div class="modal-content">
        <form method="POST" action="{{ route('admin.asset_vendors.store') }}">
          ...
          <div class="modal-header">
            <h5 class="modal-title">Tambah Vendor/Supplier</h5>
          ...
          <div class="modal-body">
            ...
            <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="mis: PT ABC" required>
          </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <form method="POST" action="{{ $editRow ? route('admin.asset_vendors.update', $editRow->id) : '#' }}" id="editForm">
          ...
          <div class="modal-header">
            <h5 class="modal-title">Edit Vendor/Supplier</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
